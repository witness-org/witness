...
class _TrainingProgramHeaderState extends State<TrainingProgramHeader> with LogMessagePreparer, StringLocalizer {
  ...
  Widget build(final BuildContext context) {
    ...
    return TrainingProgramComponentHeader(
      [
        ...
        Text(widget._program.numberOfWeeks.toNumberString(uiStrings.trainingProgramHeader_weekLabel_noun)),
        LabelledCheckbox(
          label: uiStrings.trainingProgramHeader_publishCheckbox_label,
          value: _isPublished,
