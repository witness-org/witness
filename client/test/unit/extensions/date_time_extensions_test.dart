...
void main() {
  ...
  group(getPrefixedGroupName(_sutName, 'TZDateTimeExtensions'), () {
    group('onlyDate', () {
  ...
  group(getPrefixedGroupName(_sutName, 'DateTimeExtensions'), () {
    group('onlyDateFromDateTime', () {
      test('should return a date of the same day from DateTime, with time set to midnight', () {
        final inputDate = DateTime(2021, 12, 3, 14, 46, 23, 123, 7772);
        final expectedDate = TZDateTime(_localTimezone, 2021, 12, 3, 0, 0, 0, 0);
        final outputDate = inputDate.onlyTZDate();
        expect(outputDate, expectedDate);
      });
    });
  });
