...
public interface WorkoutLogService {
   ...
   * @param firebaseId the Firebase ID of the user for whom {@code workoutLog} should be logged
   ...
   *                                 {@code workoutLog} does not exist
   ...
   *                     are associated with the same position) and for every ID, there must be an association. Furthermore, positions must be
